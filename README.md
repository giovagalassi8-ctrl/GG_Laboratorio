...
- [01_Environment_list](./01_Environment_list): List of all computational environments used.
- [02_KmerBased_GenomeSurvey](./02_KmerBased_GenomeSurvery):  Quality assessment of sequencing outputs using k-mer analysis.
